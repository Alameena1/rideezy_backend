...
// New route for checking ongoing rides
router.get("/users/:userId/ongoing-rides", adminAuthMiddleware, adminController.checkUserOngoingRides.bind(adminController) as RequestHandler);
