...
router.patch("/vehicles/:vehicleId/status", adminAuthMiddleware, adminController.updateVehicleStatus.bind(adminController) as RequestHandler);    router.patch("/rides/:rideId/block", adminAuthMiddleware, adminController.blockRide.bind(adminController) as RequestHandler);
